...
# Modifed for use in Nuke11+  - 22/10/2018
...
class ThumbnailExportUI(hiero.ui.TaskUIBase):
  ...
  def populateUI(self, widget, exportTemplate):
    ...
    thumbFrameLayout = QtGui.QHBoxLayout()
    self._frameTypeComboBox = QtGui.QComboBox()    
    ...
    self._customFrameLineEdit = QtGui.QLineEdit()
    self._customFrameLineEdit.setEnabled(False)
    self._customFrameLineEdit.setToolTip("This is the frame offset from the first frame of the shot/sequence")
    self._customFrameLineEdit.setValidator(PySide2.QtGui.QIntValidator())
    ...
    self._formatComboBox = QtGui.QComboBox()
    ...
    # QImage save height
    # Thumb frame type layout
    thumbSizeLayout = QtGui.QHBoxLayout()

    self._thumbSizeComboBox = QtGui.QComboBox()
